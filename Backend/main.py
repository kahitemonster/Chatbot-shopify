...
load_dotenv(".env")
openai.api_key = os.getenv("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")
...
# Initialize session_prompt variable with the data file content using the read_file method.
